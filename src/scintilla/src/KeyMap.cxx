...
const KeyToCommand KeyMap::MapDefault[] = {
    ...
    {Key('['),			(SCI_CTRL | SCI_ALT),	Message::ParaUp},
    {Key('['),			(SCI_CTRL | SCI_SHIFT | SCI_ALT),	Message::ParaUpExtend},
    {Key(']'),			(SCI_CTRL | SCI_ALT),	Message::ParaDown},
    {Key(']'),			(SCI_CTRL | SCI_SHIFT | SCI_ALT),	Message::ParaDownExtend},
    ...
    {Key('/'),		    (SCI_CTRL | SCI_ALT),	Message::WordPartLeft},
    {Key('/'),		    (SCI_CTRL | SCI_SHIFT | SCI_ALT),	Message::WordPartLeftExtend},
    {Key('\\'),		    (SCI_CTRL | SCI_ALT),	Message::WordPartRight},
    {Key('\\'),		    (SCI_CTRL | SCI_SHIFT | SCI_ALT),	Message::WordPartRightExtend},
